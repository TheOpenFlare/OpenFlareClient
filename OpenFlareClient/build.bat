...
MSBuild.exe OpenFlareClient.csproj /t:Rebuild /p:Configuration=Release /p:Platform="x86"
MSBuild.exe OpenFlareClient.csproj /t:Rebuild /p:Configuration=Release /p:Platform="x64"
echo 